...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/py-tools-ds-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/py-tools-ds-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add py-tools-ds
# for installing globally
pixi global install py-tools-ds
```
...
It is possible to list all of the versions of `py-tools-ds` available on your platform:
...
```
pixi search py-tools-ds --channel conda-forge
```
